...
(function( $ ){
	...
	var methods = {
		...
		imageWidget: function(){
			...
			}).appendTo($("<span/>", {class:"input-group-btn form-controll-button-right"}).appendTo(getImageURL));
				...
				id :"tblErrMsg"+idExtn
					...
					id:"tblForm"+idExtn
						...
						class:"row"
							...
							id:"tblRows"+idExtn,
							type:"text",
							class:"form-controll form-controll-width",
							value:2
						...
						)).append($('<select/>',{ id:"tblAlign"+idExtn, class:"form-controll form-controll-width"}
		...
		imageAttributeWidget: function(){
			...
			var edtTablecntr=$('<div/>',{
					...
					id:"imgAlt",
					type:"text",
					class:"form-controll form-controll-link ",
					placeholder:"提示文字"
				})).append($('<input/>',{
					id:"imgTarget",
					class:"form-controll form-controll-link ",
